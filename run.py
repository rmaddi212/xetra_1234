...
def main():
    ...
    #config_path = "C:/mydevelop/xetra_project/xetra_1234/configs/xetra_report1_config.yml"
    ...
    logger.info("This is a test msg from main function")

    #reading s3 configuration
    s3_config = config['s3']

    #creating S3 Bucketconnector class instances for source and target
