...
class TestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[4:4],'2021-04-18/2021-04-18_BINS_XETR04.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[5:5],'2021-04-18/2021-04-18_BINS_XETR06.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[6:6],'2021-04-19/2021-04-19_BINS_XETR01.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[7:7],'2021-04-19/2021-04-19_BINS_XETR02.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[8:8],'2021-04-19/2021-04-19_BINS_XETR03.csv','csv')
    ...
    def test_transform_report1_ok(self):
        ...
        log2_exp ='Applying transformations to Xetra source data for report 1 finished ...'
