...
class IntTestXetraETLMethods(unittest.TestCase):
    """
    Integration Testing XetraETLMethods
    """
    def setUp(self):
        ...
        self.s3_end_point_url='https://s3-eu-west-2.amazonaws.com'        
        self.s3_bucket_name_src='rm-xetra-int-src-bucket'
        self.s3_bucket_name_trg='rm-xetra-int-trg-bucket'
        ...
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[0:0],f'{self.dates[5]}/{self.dates[5]}_BINS_XETR12.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[1:1],f'{self.dates[4]}/{self.dates[4]}_BINS_XETR15.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[2:2],f'{self.dates[3]}/{self.dates[3]}_BINS_XETR13.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[3:3],f'{self.dates[3]}/{self.dates[3]}_BINS_XETR14.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[4:4],f'{self.dates[2]}/{self.dates[2]}_BINS_XETR04.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[5:5],f'{self.dates[2]}/{self.dates[2]}_BINS_XETR06.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[6:6],f'{self.dates[1]}/{self.dates[1]}_BINS_XETR01.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[7:7],f'{self.dates[1]}/{self.dates[1]}_BINS_XETR02.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[8:8],f'{self.dates[1]}/{self.dates[1]}_BINS_XETR03.csv','csv')
