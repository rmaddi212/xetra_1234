...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def test_list_files_in_prefix_wrong_prefix(self):
        """
        Tests the list_files_in_prefix method in case of a wrong or note existing prefix        
        """
        #Expected results
    ...
    def test_read_csv_to_df_ok(self):
        ...
        val1_exp ='val1'
        val2_exp ='val2'
        log_exp =f'Reading file {self.s3_end_point_url}/{self.s3_bucket_name}/{key_exp}'
    ...
    def test_write_df_to_s3_empty(self):
        ...
        # Expected results
        return_exp = None
        log_exp = 'The data frame is empty! No file will be written!'
    ...
    def test_write_df_to_s3_csv(self):
        """
        Tests the write to df_to_s3_method
        ...
        key_exp ='test.csv'
        log_exp = f'Writing file to {self.s3_end_point_url}/{self.s3_bucket_name}/{key_exp}'
    ...
    def test_write_df_to_s3_parquet(self):
        """
        Tests the write to df_to_s3_method
        if writing parque is successful
        """
